...
// +kubebuilder:rbac:groups=novanas.io,resources=storagequotas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=novanas.io,resources=storagequotas/status,verbs=get;update;patch
...
func (r *QuotaReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&novastorev1alpha1.StorageQuota{}).
		Named("storagequota").
		Complete(r)
}
