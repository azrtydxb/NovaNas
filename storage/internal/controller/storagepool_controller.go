...
// +kubebuilder:rbac:groups=novanas.io,resources=storagepools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=novanas.io,resources=storagepools/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=novanas.io,resources=storagepools/finalizers,verbs=update
// +kubebuilder:rbac:groups=novanas.io,resources=backendassignments,verbs=get;list;watch;create;update;patch;delete
