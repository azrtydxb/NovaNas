...
import (
	...
	nvmepb "github.com/azrtydxb/novanas/storage/api/proto/nvme"
...
const (
	...
	TopologyDomain = "novanas.io/node"
)
...
//
// For NovaStor, we match based on the TopologyDomain key (novanas.io/node).
