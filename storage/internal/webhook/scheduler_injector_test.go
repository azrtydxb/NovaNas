			...
			pvcs: []runtime.Object{
				&corev1.PersistentVolumeClaim{
					...
					Spec: corev1.PersistentVolumeClaimSpec{
						StorageClassName: strPtr("novanas-block-replicated"),
					},
				},
			},
			storageClasses: []runtime.Object{
		...
		},
		{
			...
			pvcs: []runtime.Object{
				...
				&corev1.PersistentVolumeClaim{
					...
					Spec: corev1.PersistentVolumeClaimSpec{
						StorageClassName: strPtr("novanas-block-erasure"),
					},
				},
			},
			storageClasses: []runtime.Object{
