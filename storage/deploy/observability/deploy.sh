...
kubectl -n novanas-system rollout status deployment/tempo --timeout=60s
kubectl -n novanas-system rollout status deployment/pyroscope --timeout=60s
kubectl -n novanas-system rollout status deployment/grafana --timeout=120s
