...
const (
	failoverNamespace    = "novanas-system"
	failoverStorageClass = "novanas-block-replicated"
...
// getWriteOwnerAgent returns the name and node of the novanas-storage-agent pod that
...
//
// The test flow:
//  1. Create a PVC with the novanas-block-replicated StorageClass
...
func TestSPDKFailover(t *testing.T) {
	...
	// -----------------------------------------------------------------
	// Step 1: Create a PVC with the novanas-block-replicated StorageClass.
	// -----------------------------------------------------------------
	t.Log("step 1: creating PVC with novanas-block-replicated StorageClass")
