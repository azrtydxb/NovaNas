...
func TestRunTLSBootstrap_MissingFlags(t *testing.T) {
	...
	os.Args = []string{"novanas-storage-controller", "tls-bootstrap"}
	err := runTLSBootstrap()
	if err == nil {
...
func TestRunTLSBootstrap_MissingNamespace(t *testing.T) {
	...
	os.Args = []string{"novanas-storage-controller", "tls-bootstrap", "--secret-name=test-secret"}
	err := runTLSBootstrap()
	if err == nil {
...
func TestRunTLSBootstrap_NoInClusterConfig(t *testing.T) {
	...
	os.Args = []string{"novanas-storage-controller", "tls-bootstrap", "--secret-name=test", "--namespace=default"}
	err := runTLSBootstrap()
	if err == nil {
