...
const file_metadata_metadata_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\xa2\x02\n" +
	"\x0eSuperblockInfo\x12\x1b\n" +
	"\tdisk_uuid\x18\x01 \x01(\fR\bdiskUuid\x12\x17\n" +
	"\apool_id\x18\x02 \x01(\tR\x06poolId\x12\x12\n" +
	"\x04role\x18\x03 \x01(\tR\x04role\x12!\n" +
	"\fcrush_digest\x18\x04 \x01(\fR\vcrushDigest\x12(\n" +
	"\x10meta_volume_name\x18\x05 \x01(\tR\x0emetaVolumeName\x12(\n" +
	"\x10meta_volume_root\x18\x06 \x01(\tR\x0emetaVolumeRoot\x12.\n" +
	"\x13meta_volume_version\x18\a \x01(\x04R\x11metaVolumeVersion\x12\x1f\n" +
	"\vdevice_path\x18\b \x01(\tR\n" +
	"devicePath\"o\n" +
	"\x18ReportSuperblocksRequest\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12:\n" +
	"\vsuperblocks\x18\x02 \x03(\v2\x18.metadata.SuperblockInfoR\vsuperblocks\"\x99\x01\n" +
	"\x19ReportSuperblocksResponse\x12%\n" +
	"\x0eaccepted_count\x18\x01 \x01(\rR\racceptedCount\x12%\n" +
	"\x0equorum_reached\x18\x02 \x01(\bR\rquorumReached\x12.\n" +
