...
SOCK="/var/tmp/novanas-spdk.sock"
PASS=0
FAIL=0
TOTAL=0
...
NQN_RAW="nqn.2024-01.io.novanas:volume-nvmeof-raw-test"
...
NQN_LVM="nqn.2024-01.io.novanas:volume-nvmeof-lvm-test"
...
NQN_A="nqn.2024-01.io.novanas:volume-nvmeof-multi-a"
NQN_B="nqn.2024-01.io.novanas:volume-nvmeof-multi-b"
...
RES=$(rpc "nvmf_list_subsystems" '{}')
TOTAL=$((TOTAL + 1))
DEL_NQN="nqn.2024-01.io.novanas:volume-nvmeof-del-test"
