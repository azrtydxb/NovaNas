...
impl FileChunkStore {
    ...
    ///
    /// Creates a backing file at `<base_dir>/novanas-chunks.dat` and registers
    ...
    pub fn new(base_dir: PathBuf, capacity_bytes: u64) -> Result<Self> {
        ...
        let backing_file = base_dir.join("novanas-chunks.dat");
...
mod tests {
    ...
    fn bdev_name_derived_from_dir() {
        ...
        let dir = PathBuf::from("/var/lib/novanas/pool1");
