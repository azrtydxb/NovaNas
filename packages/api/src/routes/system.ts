...
export async function systemRoutes(app: FastifyInstance): Promise<void> {
  registerStubs(app, [
    { method: 'GET', url: '/api/v1/system/info', summary: 'System info (CPU, RAM, uptime)', tag: 'system' },
    ...
    { method: 'POST', url: '/api/v1/system/reboot', summary: 'Reboot the appliance', tag: 'system' },
    { method: 'POST', url: '/api/v1/system/shutdown', summary: 'Shutdown the appliance', tag: 'system' },
  ]);
}
