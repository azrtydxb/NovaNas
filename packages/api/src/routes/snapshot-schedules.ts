  ...
  registerUnavailable(app, [
    {
      ...
      summary: 'List SnapshotSchedules',
      tag: 'snapshot-schedules',
    },
    {
      method: 'POST',
      url: '/api/v1/snapshot-schedules',
      summary: 'Create a SnapshotSchedule',
      tag: 'snapshot-schedules',
    },
    {
      method: 'GET',
      url: '/api/v1/snapshot-schedules/:name',
      summary: 'Get a SnapshotSchedule',
      tag: 'snapshot-schedules',
    },
    {
      method: 'PATCH',
      url: '/api/v1/snapshot-schedules/:name',
      summary: 'Update a SnapshotSchedule',
      tag: 'snapshot-schedules',
    },
    {
      method: 'DELETE',
      url: '/api/v1/snapshot-schedules/:name',
      summary: 'Delete a SnapshotSchedule',
      tag: 'snapshot-schedules',
    },
  ]);
}
