  ...
  registerUnavailable(app, [
    {
      ...
      summary: 'List CloudBackupTargets',
      tag: 'cloud-backup-targets',
    },
    {
      method: 'POST',
      url: '/api/v1/cloud-backup-targets',
      summary: 'Create a CloudBackupTarget',
      tag: 'cloud-backup-targets',
    },
    {
      method: 'GET',
      url: '/api/v1/cloud-backup-targets/:name',
      summary: 'Get a CloudBackupTarget',
      tag: 'cloud-backup-targets',
    },
    {
      method: 'PATCH',
      url: '/api/v1/cloud-backup-targets/:name',
      summary: 'Update a CloudBackupTarget',
      tag: 'cloud-backup-targets',
    },
    {
      method: 'DELETE',
      url: '/api/v1/cloud-backup-targets/:name',
      summary: 'Delete a CloudBackupTarget',
      tag: 'cloud-backup-targets',
    },
  ]);
}
