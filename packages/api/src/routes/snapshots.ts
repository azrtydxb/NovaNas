...
export async function snapshotRoutes(app: FastifyInstance): Promise<void> {
  registerStubs(app, [
    ...
    { method: 'POST', url: '/api/v1/snapshots/:id/rollback', summary: 'Roll back', tag: 'snapshots' },
    { method: 'DELETE', url: '/api/v1/snapshots/:id', summary: 'Delete a snapshot', tag: 'snapshots' },
  ]);
}
