  ...
  registerUnavailable(app, [
    {
      ...
      summary: 'List ReplicationTargets',
      tag: 'replication-targets',
    },
    {
      method: 'POST',
      url: '/api/v1/replication-targets',
      summary: 'Create a ReplicationTarget',
      tag: 'replication-targets',
    },
    {
      method: 'GET',
      url: '/api/v1/replication-targets/:name',
      summary: 'Get a ReplicationTarget',
      tag: 'replication-targets',
    },
    {
      method: 'PATCH',
      url: '/api/v1/replication-targets/:name',
      summary: 'Update a ReplicationTarget',
      tag: 'replication-targets',
    },
    {
      method: 'DELETE',
      url: '/api/v1/replication-targets/:name',
      summary: 'Delete a ReplicationTarget',
      tag: 'replication-targets',
    },
  ]);
}
